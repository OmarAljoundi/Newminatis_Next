...
const ShopRootLayout: FC<ShopRootLayoutProp> = ({ children }) => {
  ...
  const handleSortChange = (e: string) => {
    ...
    router.push(("/shop" + "?" + path.slice(0, -1)) as any, {
        ...
        <section aria-labelledby="products-heading" className="pb-24 pt-6">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <form className="hidden lg:block">
              ...
              <Disclosure
                as="div"
                className="border-b border-gray-200 py-6 drop-shadow"
              >
                {({ open }) => (
                  <>
                    <h3 className="-my-3 flow-root">
                      <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                        ...
                        <span className="ml-6 flex items-center px-2">
                          {open ? (
                    ...
                    <Disclosure.Panel className="pt-6">
                      <div className="space-y-4 ">
                        {categories.map((option, optionIdx) => (
                          ...
                          >
                            <Link
                              href={`/shop/${option.href}`}
                              className="ml-3 text-sm text-gray-600 w-9"
                            >
                              {option.name}
                            </Link>
                            <AiOutlineArrowRight />
