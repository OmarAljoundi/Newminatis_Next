      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="mb-8">
          ...
          <div className="w-auto text-base lg:text-xl font-medium">
            ...
            is a fashion brand merging high fashion with futuristic elements to
            represent a global culture promoting a natural state of the soul.
            The brand transcends fashion, inspiring creativity, inclusivity, and
            individuality through alternative and deconstructed designs.
            Utilizing high-tech materials,{" "}
            <span className="bg-gray-400 rounded-2xl px-2 text-white">
              NEWMINATIS
            </span>{" "}
        ...
        <div className="mb-6">
          ...
          <div className="mb-4 flex items-center relative">
            ...
            <div className="text-base ml-4 font-medium">
              ...
              you to push past your comfort zone and explore your true identity
              through various forms of art, fashion, music, and other creative
              outlets.
            </div>
          </div>
          <div className="mb-4 flex items-center relative">
            ...
            <div className="text-base ml-4 font-medium">
              ...
              style of fashion where the traditional structure and construction
              of clothing is intentionally altered or undone. This style of
              fashion aims to challenge traditional notions of what clothing
              should look like and how it should be constructed.
            </div>
          </div>
          <div className="mb-4 flex items-center relative">
            <div className="w-[3px] bg-gray-500 absolute top-0 bottom-0 left-0 right-auto"></div>
            <div className="text-base ml-4 font-medium">
              ...
              pushes the limits of fashion by embracing creativity, innovation,
              and individuality. Through experimentation with diverse materials
              and techniques, we redefine the fashion landscape, nurturing a
              vibrant and supportive avant-garde community.
            </div>
          </div>
        </div>
